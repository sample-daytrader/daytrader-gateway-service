...
##  4.  Routing Variables
ENV DAYTRADER_ACCOUNTS_SERVICE=http://accounts-service:1443
ENV DAYTRADER_GATEWAY_SERVICE=http://gateway-service:2443
ENV DAYTRADER_PORTFOLIOS_SERVICE=http://portfolios-service:3443
ENV DAYTRADER_QUOTES_SERVICE=http://quotes-service:4443
##  5.  Logging Variables
